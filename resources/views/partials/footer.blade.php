  <footer class="site-footer">
    <div class="container footer-grid">
      ...
      <div><h2>Explore</h2><a href="{{ route('packages.index') }}">Packages</a><a href="{{ route('products.index') }}">Products</a><a href="{{ route('home') }}#branches">Branches</a></div>
    ...
    <div class="container footer-bottom"><span>© <span id="year"></span> Armour. All rights reserved.</span><span>armour.ph</span></div>
  </footer>
